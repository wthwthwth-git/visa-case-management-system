...
const errorNameToCode: Record<string, ApiErrorCode> = {
  ...
  PortalFileDeleteAccessError: "FILE_NOT_ACCESSIBLE",
  PortalRequirementSubmitAccessError: "INVALID_REQUEST",
  ...
  CaseDeleteAccessError: "INVALID_REQUEST",
  InvalidAdminCustomerInputError: "INVALID_REQUEST",
  AdminCustomerAccessError: "INVALID_REQUEST",
  ...
  AdminNotificationAccessError: "INVALID_REQUEST",
